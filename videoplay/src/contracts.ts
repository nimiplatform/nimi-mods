...
export const VIDEOPLAY_REASON = {
  ...
  STAGE_PRECONDITION_BLOCKED: 'VIDEOPLAY_STAGE_PRECONDITION_BLOCKED',
  STAGE_ADVANCE_REQUIRED: 'VIDEOPLAY_STAGE_ADVANCE_REQUIRED',
...
export type VideoPlayWorkbenchStage =
  typeof VIDEOPLAY_WORKBENCH_STAGE_ORDER[number];

export const VIDEOPLAY_WORKBENCH_STAGE_STATUS = {
  EMPTY: 'empty',
...
export type VideoPlayWorkbenchStageStatus =
  typeof VIDEOPLAY_WORKBENCH_STAGE_STATUS[keyof typeof VIDEOPLAY_WORKBENCH_STAGE_STATUS];
