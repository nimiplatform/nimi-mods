...
## V-FACT-007 Editable Pipeline Trace Preservation

When creator edits outputs between stages and reruns downstream steps, `episode/clip/beat/shot` traceability must remain valid and continue to satisfy canonical subset checks.
