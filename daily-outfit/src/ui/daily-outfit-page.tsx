...
export function DailyOutfitPage() {
  ...
  return (
    <div className="min-h-full bg-[radial-gradient(circle_at_top_left,#fed7aa_0%,transparent_32%),linear-gradient(180deg,#fff7ed_0%,#fafaf9_42%,#ffffff_100%)] px-6 py-8 text-neutral-950">
