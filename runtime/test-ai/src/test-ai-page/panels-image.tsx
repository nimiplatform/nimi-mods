  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <ImageDraftEditor
        ...
        isLocalAIImageWorkflow={isLocalAIImageWorkflow}
        artifacts={artifacts}
        artifactLoading={artifactLoading}
        artifactError={artifactError}
        hasKnownCompanionArtifacts={hasKnownCompanionArtifacts}
        coreCompanionPresets={coreCompanionPresets}
        extendedCompanionPresets={extendedCompanionPresets}
        companionPresetArtifacts={companionPresetArtifacts}
      ...
      {mode === 'job' ? (
        <ImageJobPanel
          ...
          onWatchJobIdChange={setWatchJobId}
          onWatchExistingJob={() => { void handleWatchExistingJob(); }}
          onCancelJob={() => { void handleCancelJob(); }}
          onSubmitJob={() => { void handleRun(); }}
