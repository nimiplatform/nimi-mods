...
export function DiagnosticsPanel(props: Props) {
    ...
    const { open, onToggle, latestPromptTrace, latestTurnAudit, healthStatus, checkingHealth, onHealthCheck, } = props;
    ...
    return (<div className="lc-card rounded-2xl p-3 text-xs">
      ...
      {open ? (<div className="mt-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            {metricItems.map((item) => (<div key={item.key} className="rounded-xl border border-gray-200 bg-white px-2.5 py-2">
          ...
          <button type="button" onClick={onHealthCheck} disabled={checkingHealth} className="lc-btn lc-btn-secondary flex h-10 w-full items-center gap-2 px-4 text-sm font-semibold disabled:opacity-60">
