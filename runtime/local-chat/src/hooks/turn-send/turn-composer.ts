import type { InteractionBeat, InteractionTurnPlan, LocalChatContextPacket, LocalChatTurnMode, } from '../../state/index.js';
...
function isCrossTurnDuplicate(text: string, recentBeatTexts: string[]): boolean {
    ...
    if (!normalized || recentBeatTexts.length === 0)
        return false;
