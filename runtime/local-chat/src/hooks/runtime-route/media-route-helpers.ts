...
import { type RuntimeCanonicalCapability, type RuntimeRouteOptionsSnapshot } from "@nimiplatform/sdk/mod";
...
export function resolveMediaDependencyRouteSourceHint(input: {
    ...
    const configuredSource = normalizeRouteSource(input.kind === 'image'
