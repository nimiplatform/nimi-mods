...
export type ProjectState = 'draft' | 'imported' | 'analyzing' | 'analyzed' | 'casting' | 'cast_complete' | 'synthesizing' | 'done' | 'done_with_errors' | 'cancelled' | 'paused';
/** Voice source strategy */
export type VoiceSource = 'preset' | 'designed';
/** Synthesis job status */
export type SynthesisJobStatus = 'idle' | 'running' | 'done' | 'done_with_errors' | 'cancelled' | 'paused';
/** Segment job status */
