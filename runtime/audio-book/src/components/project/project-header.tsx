...
export function ProjectHeader(props: ProjectHeaderProps) {
    ...
    return (<div className="flex w-full items-center justify-between">
      {/* Logo + Back */}
      <button type="button" onClick={props.onBack} className="flex items-center gap-2 rounded-lg px-1 py-1 text-gray-700 transition-colors hover:bg-gray-50" title={t('projectHeader.backToProjects')}>
      ...
      {/* Step indicator */}
      <StepIndicator steps={props.steps} currentStep={props.currentStep} currentIndex={props.currentIndex} canEnterStep={props.canEnterStep} onStepClick={props.onStepClick}/>
    </div>);
}
