...
export async function synthesizeDna(input: {
    ...
    try {
        ...
        if (!validation.success) {
            ...
            return {
                ...
                error: {
                    ...
                    message: mintYouMessage('Errors.dnaSchemaInvalid', 'LLM output schema validation failed: {{issues}}', { issues }),
                    actionHint,
                },
            };
        }
        ...
        const timeoutLike = (lower.includes('timeout')
        ...
        return {
            ...
            error: {
                reasonCode: MINTYOU_REASON.DNA_SYNTHESIS_FAILED,
                message: timeoutLike
                    ? mintYouMessage('Errors.dnaSynthesisTimeout', 'DNA synthesis timed out. Please retry or switch model.')
                    : mintYouMessage('Errors.dnaSynthesisFailed', 'DNA synthesis failed: {{detail}}', { detail: normalized }),
                actionHint,
            },
        };
    }
