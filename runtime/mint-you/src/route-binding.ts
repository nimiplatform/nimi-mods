import { type RuntimeRouteBinding, type RuntimeRouteLocalOption, type RuntimeRouteOptionsSnapshot } from "@nimiplatform/sdk/mod";
...
export function ensureMintYouRouteOptionsSnapshotShape(snapshot: RuntimeRouteOptionsSnapshot | null): RuntimeRouteOptionsSnapshot | null {
    if (!snapshot) {
        return null;
    }
    return {
...
export function areMintYouRouteBindingsEqual(left: RuntimeRouteBinding | null | undefined, right: RuntimeRouteBinding | null | undefined): boolean {
    if (!left && !right) {
        return true;
    }
    if (!left || !right) {
...
export function sanitizeMintYouRouteBinding(binding: RuntimeRouteBinding | null | undefined, routeOptions: RuntimeRouteOptionsSnapshot | null): RuntimeRouteBinding | null {
    if (!binding) {
        return null;
    }
