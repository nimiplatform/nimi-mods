    ...
    return (<div className="ui-sync-root relative flex h-full min-h-0 overflow-hidden">
      ...
      <div className="ui-sync-pane ui-sync-pane-main flex min-h-0 min-w-0 flex-1 flex-col">
        <div className="mx-4 mt-4 flex items-center gap-3">
          ...
          <button type="button" onClick={() => setSettingsOpen(true)} className="ui-sync-btn ui-sync-btn-secondary inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-full border text-gray-700 shadow-[0_12px_24px_rgba(15,23,42,0.08)]" aria-label={t('SettingsDrawer.open')} title={t('SettingsDrawer.open')}>
