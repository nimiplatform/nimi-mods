...
export function useMintYouRouteOptions() {
    ...
    const loadRouteOptions = useCallback(async (options?: {
        ...
        const task = (async () => {
            ...
            try {
                ...
                const snapshot = ensureMintYouRouteOptionsSnapshotShape(parseRuntimeRouteOptions(await runtimeClient.route.listOptions({
