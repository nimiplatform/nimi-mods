import type { WorldLorebookDraftRow, WorldStudioEmbeddingIndex, WorldStudioEmbeddingIndexEntry, WorldStudioWorkspaceSnapshot, } from '../contracts.js';
...
export async function buildWorldStudioEmbeddingIndex(input: BuildWorldStudioEmbeddingIndexInput): Promise<BuildWorldStudioEmbeddingIndexResult> {
