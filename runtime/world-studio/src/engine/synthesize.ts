...
function buildSynthesizePrompt(input: {
    ...
    return [
        ...
        'Schema:',
        '{',
        '  "world": {"name":"...","description":"...","lore":"...","genre":"...","themes":["..."],"era":"...","status":"ACTIVE","timeFlowRatio":1},',
        '  "worldview": {"lifecycle": {},"timeModel": {"currentNode":"...","timeline":[]},"spaceTopology": {},"causality": {},"coreSystem": {"rules": {}},"existences": {},"resources": {},"structures": {},"visualGuide": {},"narrativeHooks": {}},',
