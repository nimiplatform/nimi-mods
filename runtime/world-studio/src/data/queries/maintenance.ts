import { WORLD_STUDIO_DATA_API_MAINTENANCE_GET, WORLD_STUDIO_DATA_API_MAINTENANCE_UPDATE, WORLD_STUDIO_DATA_API_MUTATIONS_LIST, WORLD_STUDIO_DATA_API_WORLDS_MINE, } from '../../contracts.js';
...
export async function updateWorldMaintenance(hookClient: HookClient, worldId: string, patch: Record<string, unknown>) {
