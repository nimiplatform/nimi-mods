...
export const WORLD_STUDIO_CAPABILITIES = [
  ...
  `data.query.${WORLD_STUDIO_DATA_API_MEDIA_BINDINGS_LIST}`,
  `data.query.${WORLD_STUDIO_DATA_API_MEDIA_BINDINGS_BATCH_UPSERT}`,
  `data.query.${WORLD_STUDIO_DATA_API_MEDIA_BINDINGS_DELETE}`,
