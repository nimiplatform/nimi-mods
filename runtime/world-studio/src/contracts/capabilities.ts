...
export const WORLD_STUDIO_CAPABILITIES = [
  ...
  `data.query.${WORLD_STUDIO_DATA_API_RESOURCE_BINDINGS_LIST}`,
  `data.query.${WORLD_STUDIO_DATA_API_RESOURCE_BINDINGS_BATCH_UPSERT}`,
  `data.query.${WORLD_STUDIO_DATA_API_RESOURCE_BINDINGS_DELETE}`,
