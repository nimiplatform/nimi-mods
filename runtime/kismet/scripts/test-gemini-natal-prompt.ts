 ...
 *   npx tsx nimi-mods/runtime/kismet/scripts/test-gemini-natal-prompt.ts
 *
 *   # Option 2: Provide API key via env
 *   GEMINI_API_KEY=your-key npx tsx nimi-mods/runtime/kismet/scripts/test-gemini-natal-prompt.ts
 *
 *   # Option 3: Override model
 *   GEMINI_MODEL=models/gemini-2.5-flash npx tsx nimi-mods/runtime/kismet/scripts/test-gemini-natal-prompt.ts
 */
