...
export const StageConversationView = React.memo(function StageConversationView({
  selectedTarget,
  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden px-6 pb-3 pt-4" onWheelCapture={handleWheelCapture}>
      ...
      <div className="relative z-10 flex min-h-0 flex-1 flex-col justify-between gap-5 pt-4">
        <div className="flex min-h-[320px] flex-1 flex-col items-center justify-center text-center">
          ...
          >
            <span
              className="lc-stage-aura absolute inset-[-22px] rounded-full opacity-70 blur-2xl"
              style={{ background: theme.accentSoft }}
            />
            <span
              className="absolute inset-[-10px] rounded-full border border-white/70"
              style={{ boxShadow: `0 18px 48px ${theme.accentSoft}` }}
            />
            <span className="lc-stage-avatar-frame relative flex h-32 w-32 items-center justify-center overflow-hidden rounded-full border border-white/85 bg-white/78 shadow-[0_20px_52px_rgba(15,23,42,0.12)]">
              {selectedTargetAvatarUrl ? (
                ...
                <span className="text-5xl font-black" style={{ color: theme.text }}>
                  {selectedTargetInitial}
                </span>
              )}
            </span>
          ...
          <div
            className="mt-5 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-semibold shadow-[0_10px_28px_rgba(15,23,42,0.08)]"
            style={{
