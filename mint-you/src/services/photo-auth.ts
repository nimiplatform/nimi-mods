import type { HookDataClient } from '@nimiplatform/sdk/mod/types';
import type {
  PhotoAuthState,
  PhotoAuthRecord,
  PhotoAuthSnapshot,
...
async function loadRecord(
  dataClient: HookDataClient,
  userA: string,
  userB: string,
  worldId: string,
): Promise<PhotoAuthRecord | null> {
...
export async function readPhotoAuthSnapshot(
  dataClient: HookDataClient,
  currentUserId: string,
  otherUserId: string,
  worldId: string,
): Promise<PhotoAuthSnapshot> {
...
export async function canSeePhoto(
  dataClient: HookDataClient,
  viewerId: string,
  ownerId: string,
  worldId: string,
