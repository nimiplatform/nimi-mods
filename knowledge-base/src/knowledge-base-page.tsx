    ...
    case 'documents':
      content = (
        <DocumentListPage
          ...
          onOpenImportDialog={() => ui.setImportDialogOpen(true)}
          onCloseImportDialog={() => ui.setImportDialogOpen(false)}
          onImportFile={controller.documentActions.importFile}
          onImportText={controller.documentActions.importText}
    ...
    case 'settings':
      content = (
        <SettingsPage
          ...
          onUpdate={(patch) => store.updateSettings(patch)}
          chatRouteOptions={controller.chatRouteOptions}
          embeddingRouteOptions={controller.embeddingRouteOptions}
          onRefreshRouteOptions={() => { void controller.refreshRouteOptions(); }}
        />
      );
      break;
  }
