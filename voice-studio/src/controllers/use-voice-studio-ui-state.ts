// ---------------------------------------------------------------------------
// Ephemeral UI state for Voice Studio (React useState)
// ---------------------------------------------------------------------------

import { useState, useCallback } from 'react';

export type VoiceStudioStep = 'import' | 'analyze' | 'cast' | 'synth' | 'play';
...
export function useVoiceStudioUiState() {
  const [currentStep, setCurrentStep] = useState<VoiceStudioStep>('import');
...
export type VoiceStudioUiState = ReturnType<typeof useVoiceStudioUiState>;
