# Voice Studio Spec Index

> Mod ID: `world.nimi.voice-studio`
> Status: Draft
> Version: 0.1.0

## Overview

Voice Studio 是一个 nimi-mod，提供多角色 AI 配音 / 有声书生成能力。核心流程：导入小说文本 → AI 分析角色与对话 → 为每个角色分配声线 → 批量生成有声书 → 文本跟读式播放。

## Architecture

```
voice-studio (nimi-mod)
│
...
- data.register.data-api.voice-studio.*
- data.query.data-api.voice-studio.*
