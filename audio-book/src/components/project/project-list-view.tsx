        ...
        <div className="mb-8 flex items-center gap-3">
          <div className="relative min-w-0 flex-1">
            ...
            <input
              ...
              className="w-full rounded-md border border-gray-200 py-2.5 pl-9 pr-3 text-sm text-gray-900 outline-none transition-colors placeholder:text-gray-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
            />
          </div>
          <button
            type="button"
        ...
        {projects.length === 0 ? (
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {projects.map((p) => (
              <div
                key={p.id}
                className="group relative rounded-lg border border-gray-200 bg-white transition-all hover:border-indigo-200 hover:shadow-sm"
              >
                <button
                  type="button"
                  onClick={() => onOpen(p.id)}
