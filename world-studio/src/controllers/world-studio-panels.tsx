...
export function buildWorldStudioPanels(viewModel: WorldStudioViewModel): {
  ...
  const rightPanel = buildWorldStudioRightPanel({
    ...
    storyProjectionCount: viewModel.metrics.storyProjectionCount,
    storyProjectionMissingContextCount: viewModel.metrics.storyProjectionMissingContextCount,
    storyProjectionLatestAt: viewModel.metrics.storyProjectionLatestAt,
