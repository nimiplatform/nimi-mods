...
import {
  applyPhase1ResultSnapshot,
  diagLog,
  hasTerminalContextOverflowFailures,
  isFinalDraftAccumulatorPopulated,
  summarizeChunkTasks,
  summarizeDraftPatch,
  summarizeFinalDraftAccumulator,
  summarizeTerminalChunkFailures,
  toTaskProgressMessage,
} from './run-phase1-utils.js';
...
export async function executePhase1ExtractionLoop(
  ctx: ExtractionLoopContext,
