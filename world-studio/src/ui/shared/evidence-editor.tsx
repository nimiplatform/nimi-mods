      ...
      <div className="mt-2 space-y-2">
        {props.value.length === 0 ? (
          ...
          <div key={`evidence-${index}`} className="ui-sync-card p-2">
            {props.contextText ? (
              <div className="ui-sync-toolbar mb-2 px-2 py-1">
                <div className="flex flex-wrap items-center gap-2">
                  <button
                    type="button"
                    className="ui-sync-btn ui-sync-btn-secondary rounded border border-gray-300 bg-white px-2 py-0.5 text-[10px] font-semibold text-gray-700 disabled:opacity-50"
            ...
            <button
              type="button"
              className="ui-sync-btn mt-2 rounded border border-red-300 bg-white px-2 py-0.5 text-[11px] font-semibold text-red-700"
              onClick={() => {
